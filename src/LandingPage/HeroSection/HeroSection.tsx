      ...
      <div className="flex flex-col items-center gap-4 w-full">
        <div className="flex flex-col items-center gap-5 w-full">
          <div className="flex items-center justify-center">
            <Badge className="flex items-center gap-0.5 px-3.5 py-2.5 bg-dark-08 text-gray-80 rounded-[100px] border border-solid border-[#26262a]">
              <svg
                ...
                className="mx-1 lucide lucide-brain-circuit-icon lucide-brain-circuit"
              >
          ...
          <div className="w-full text-center">
            <h1 className="[font-family:'Cabinet_Grotesk',Helvetica] my-3 font-medium bg-radial-gold bg-clip-text text-transparent text-[62px] leading-[64.4px] text-justify">
              Hack Your Way to a Career in Cybersecurity{" "}
            </h1>
            <p className="max-md:text-2xl text-4xl  leading-[43.2px] font-medium bg-radial-gold bg-clip-text text-transparent [font-family:'Cabinet_Grotesk',Helvetica] text-center">
        ...
        <p className="z-10 max-w-[744px] [font-family:'Instrument_Sans',Helvetica] font-medium text-gray-70 text-base text-center leading-6 max-md:text-justify px-5">
          Hacking is not mere exploitation of weaknesses; rather it is a
          systematic process comprising planning, reconnaissance, exploitation,
          and{" "}
          <span className="max-md:text-centre">
